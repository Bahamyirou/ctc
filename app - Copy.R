...
ui <- dashboardPage(
        ...
        dashboardHeader(title = "StatCTC"),
         ...
         dashboardSidebar(
                     ...
                     sidebarMenu(
                                      menuItem("About StatCTC", tabName = "ctclogo", icon = icon("info-circle")), # 4 th tab
                                      #menuItem("À propos", tabName = "widgets", icon = icon("file-lines")), # first  tab
                                      menuItem("La CTC en chiffres", tabName = "dashboard", icon = icon("chart-pie")), # 2nd tab
                                      menuItem("Analyse des adhésions", tabName = "test_FILTRE", icon = icon("chart-line")), # 3rd tab
                                      menuItem("Les sections", tabName = "dashboardsection", icon = icon("sitemap")) # 4 th tab
